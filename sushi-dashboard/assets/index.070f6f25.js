var we=Object.defineProperty,De=Object.defineProperties;var Ce=Object.getOwnPropertyDescriptors;var B=Object.getOwnPropertySymbols;var le=Object.prototype.hasOwnProperty,de=Object.prototype.propertyIsEnumerable;var ce=(e,t,r)=>t in e?we(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,M=(e,t)=>{for(var r in t||(t={}))le.call(t,r)&&ce(e,r,t[r]);if(B)for(var r of B(t))de.call(t,r)&&ce(e,r,t[r]);return e},q=(e,t)=>De(e,Ce(t));var ue=(e,t)=>{var r={};for(var n in e)le.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&B)for(var n of B(e))t.indexOf(n)<0&&de.call(e,n)&&(r[n]=e[n]);return r};import{A as Re,I as Fe,g as J,r as l,j as ee,i as te,a as Ie,k as Te,n as h,C as V,b as re,u as P,_ as pe,S as ze,c as Ae,O as Pe,d as oe,e as he,H as fe,R as We,f as ne,N as Le,h as Oe,l as Ee,B as He}from"./vendor.d491fced.js";const Ue=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function r(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerpolicy&&(i.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?i.credentials="include":a.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=r(a);fetch(a.href,i)}};Ue();const je="https://gateway.thegraph.com/api/9ef8806519029f3f631da4ba936f16a1/subgraphs/id/D7azkFFPFT5H8i32ApXLr34UQyBfxDAfKoCEK4M832M6",Be=new Re({uri:je,cache:new Fe}),qe=J`
...
`,y=({children:e,variant:t="base",paletteColor:r="text-primary",color:n="",align:a,noselect:i=!1,uppercase:d=!1,className:s="",style:c={}})=>o(rt,{variant:t,color:n||`var(--ui-palette-${r})`,align:a,noselect:i,uppercase:d,className:s,style:M({},c),children:e}),rt=h.span`
  ...
  `}
`,ye=({active:e,whitelistedRanges:t=[],onChange:r})=>{const{theme:n}=k(),a=l.exports.useMemo(()=>({"1W":{label:"1W",active:e==="1W"},"1M":{label:"1M",active:e==="1M"},all:{label:"All",active:e==="all"}}),[e]),i=l.exports.useMemo(()=>Object.keys(a).filter(s=>!t.length||t.includes(s)).map(s=>q(M({},a[s]),{key:s})),[a,t]);function d(s){a[s].active||r(s)}return o(ot,{itemsAmount:i.length,children:Je(i,(s,c)=>o(nt,{isActive:s.active,theme:n,onClick:()=>d(s.key),children:s.label},`chart-range__${c}`))})},ot=h.div`
...
`;function mt(e){return typeof e=="object"&&!Array.isArray(e)&&e!==null}function _e(e,t="",r="-"){const n=Object.keys(e),a=t?t+r:"";return n.reduce(([i,d],s)=>{const c=e[s];let x=i||[],f=d||[];if(mt(c)){const[u,b]=_e(c,a+s);b&&(x=x.concat(u),f=[...f,...b])}else x.push(a+s),f.push(c);return[x,f]},[])}const yt=({children:e,className:t="",style:r={}})=>{const{theme:n}=k();return l.exports.useEffect(()=>{bt(n)},[n]),o(vt,{className:t,style:M({},r),children:e})};function bt(e){const t=document.querySelector("html"),[r,n]=_e(e,"--ui");r.forEach((a,i)=>{t.style.setProperty(a,n[i])})}const vt=h.div`
  min-height: 100vh;
`,v=t=>{var e=ue(t,[]);const{theme:r}=k(),n=e.baseColor||r.palette.skeleton.base,a=e.highlightColor||r.palette.skeleton.highlight;return o(ze,{baseColor:n,highlightColor:a,children:o(Ae,M({},e))})},Mt=()=>o(Pe,{}),ae="0xceff51756c56ceffca006cd410b03ffc46dd3a58",I=2;function ie(e,t){const r=String(e);if(r.includes(".")){const n=r.indexOf("."),a=r.substring(0,n),i=r.substring(n,n+t+1);return`${a}${t?i:""}`}return r}function T(e,t=8){const r=ie(e,t),n=r.indexOf("."),a=n===-1?r:r.substring(0,n),i=n===-1?"":r.substring(n,n+t+1);return`${a.replace(/\B(?=(\d{3})+(?!\d))/g,",")}${i}`}const _t=({pairId:e})=>{const{t}=P(),[r,n]=l.exports.useState("1M"),a=l.exports.useMemo(()=>r==="1W"?7:r==="1M"?31:365,[r]),{loading:i,data:d=null}=oe(qe,{variables:{pairId:e,amount:a},fetchPolicy:"cache-first",nextFetchPolicy:"cache-first"}),s=l.exports.useMemo(()=>d?d.pair.dayData.map(f=>[f.date*1e3,Number(ie(f.reserveUSD,I))]).reverse():[],[d]),c=l.exports.useMemo(()=>{var f;return((f=s[s.length-1])==null?void 0:f[1])||0},[s]),x=l.exports.useMemo(()=>{var u;const f=((u=s[s.length-1])==null?void 0:u[0])||Date.now();return he(f).format("MMM DD")},[s]);return o(lt,{data:s,manualRange:r,rangesMode:"manual",onRangeChange:f=>n(f),loading:i,color:"#14A887",tooltipLabel:t("Liquidity"),tooltipValue:f=>`${T(f,I)}$`,children:p($t,{children:[o(St,{children:i?p(_,{children:[o(v,{width:"80px",height:"14px",borderRadius:"4px"}),o(v,{width:"60px",height:"14px",borderRadius:"4px"})]}):p(_,{children:[o(y,{variant:"h5",children:t("Liquidity")}),o(y,{paletteColor:"text-secondary",children:x})]})}),o("div",{children:i?o(v,{width:"145px",height:"18px",borderRadius:"4px"}):p(y,{variant:"h3",children:["$",T(c,I)]})})]})})},$t=h.div`
  display: flex;
  flex-direction: column;
  gap: 4px;
`,St=h.div`
...
`,Et=h.div`
  display: flex;
  gap: 6px;
`,Ht=()=>{const{t:e}=P(),{loading:t,data:r}=oe(Ve,{variables:{pairId:ae},fetchPolicy:"network-only",nextFetchPolicy:"cache-first"}),n=(r==null?void 0:r.pair)||null;return p(_,{children:[o(fe,{children:o("title",{children:e("Home")})}),o(Ut,{children:p(jt,{children:[p(Bt,{children:[o(y,{variant:"h1",children:e("FE Test exercise")}),p(y,{paletteColor:"text-secondary",children:[e("Good luck")," :)"]})]}),p(qt,{children:[o(Se,{pair:n,targetToken:0,priceDecimals:1,loading:t}),o(Se,{pair:n,targetToken:1,priceDecimals:5,loading:t}),o(_t,{pairId:ae}),o(Lt,{pairId:ae})]})]})})]})},Ut=h.div`
  min-height: 100vh;
  padding: 80px;
  box-sizing: border-box;
  display: flex;
...
`,Vt=()=>o(We,{children:p(ne,{path:"/",element:o(Mt,{}),children:[o(ne,{index:!0,element:o(Ht,{})}),o(ne,{path:"*",element:o(Le,{to:"/"})})]})}),Nt=()=>o(yt,{children:o(Vt,{})});const Gt=document.getElementById("root"),Xt=Oe(Gt);Xt.render(o(l.exports.StrictMode,{children:o(Ee,{client:Be,children:o(Qe,{children:p(He,{children:[o(fe,{titleTemplate:`%s - Sushi ${te.t("Dashboard")}`}),o(Nt,{})]})})})}));
